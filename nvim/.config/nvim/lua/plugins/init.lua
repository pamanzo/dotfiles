return {
  {
    ...
    event = "BufWritePre", -- Esto habilita el formateo al guardar
    opts = require "configs.conform", -- Le decimos que busque las opciones en otro archivo
  },
  ...
  },
  {
    ...
    lazy = false,
    config = function()
      -- Esto evita que el plugin intente guardar/restaurar la posición del cursor
      vim.g.tidal_preserve_cursor = 0

      -- Aprovecha para asegurar que use Neovim y no Vim viejo
